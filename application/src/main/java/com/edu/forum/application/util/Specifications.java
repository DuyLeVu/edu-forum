...
public class Specifications {
  ...
  public static <E> Specification<E> doSearch(List<SingularAttribute<E, String>> attributes, String value) {
    Specification<E> attr = doContain(attributes.get(0), value);
  ...
  public static <E, F, T> Specification<E> equalsJoin(SingularAttribute<E, Long> joinAttr, Class<F> subEntity,
                                                      SingularAttribute<F, Long> joinSubAttr, SingularAttribute<F, T> attribute, T value) {
    if (value == null) {
      return null;
    }
